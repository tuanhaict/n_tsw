...
def get_config(argv=None):
    ...
    p.add_argument("--lambda_", type=float, default=0.0, help="Lambda parameter for NWTM.")
    p.add_argument("--noisy_mode", type=str, default=None, help="Noisy mode for NWTM (e.g., 'gaussian').")
    p.add_argument("--p_noise", type=float, default=2, help="Noise parameter for NWTM.")
