...
class S2WTM:
    def __init__(self, bow_dim=10000, n_topic=20, device=None,
                 ...
                 num_projections=100, ftype='linear', degree=3, p=2, n_trees=None, delta=None, n_function="power", p_agg=2, noisy_mode=None, lambda_=0.0, p_noise=2
                 ):
        ...
        for epoch in range(start_epoch, self.num_epochs):
            ...
            for iter, data in enumerate(data_loader):
                ...
                if self.loss_type=='sbstsw':
                    ...
                    assert self.n_trees is not None and self.delta is not None
                    ot_loss = self.wae.nstsw_cost(theta_q,
                                                          theta_prior,
                                                          n_trees=self.n_trees,
                                                          n_lines=self.num_projections//self.n_trees,
                                                          delta=self.delta,
