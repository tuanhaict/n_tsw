...
class S2WTM(AbstractModel):
    ...
    def __init__(self, num_topics=10, num_epochs=100, batch_size=256,
                 ...
                 ftype='linear', degree=3, p=2, n_trees=None, delta=None, n_function="power", p_agg=2, noisy_mode=None, lambda_=0.0, p_noise=2
                 ):
        ...
        self.hyperparameters['noisy_mode'] = noisy_mode
        self.hyperparameters['lambda_'] = lambda_
        self.hyperparameters['p_noise'] = p_noise
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10, save_dir=None):
        ...
        if self.use_partitions and not self.use_validation:
            ...
            self.model = SphSlicedWTM(
                ...
                noisy_mode=self.hyperparameters['noisy_mode'],
                lambda_=self.hyperparameters['lambda_'],
                p_noise=self.hyperparameters['p_noise']
                )
